...
class ProjectController extends Controller
{
    ...
    public function buildShowPayload(Request $request, Project $project): array
    {
        ...
        $events = $project->events->map(fn ($e) => [
            ...
            'start_at' => optional($e->start_at)?->format('Y-m-d\TH:i:s'),
            'end_at' => optional($e->end_at)?->format('Y-m-d\TH:i:s'),
            ...
            'exceptions' => $e->exceptions->map(fn ($ex) => [
                ...
                'start_at' => optional($ex->start_at)?->format('Y-m-d\TH:i:s'),
                'end_at' => optional($ex->end_at)?->format('Y-m-d\TH:i:s'),
                'all_day' => $ex->all_day,
                'color' => $ex->color,
            ])->values(),
        ])->values();
